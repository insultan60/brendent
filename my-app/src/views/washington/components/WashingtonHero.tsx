...
import { washingtonHero } from '@/mocks/washingtonData';
import { CtaButton, Eyebrow, GhostButton } from '@/views/home-v2/components/shared';

export default function WashingtonHero() {
  return (
      ...
      <div className="relative mx-auto flex min-h-[94svh] max-w-[1500px] flex-col justify-between gap-12 px-5 pb-14 pt-36 md:px-10 md:pb-20 md:pt-44">
        <div className="flex flex-col gap-11 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
          <div className="v2-rise max-w-3xl">
            <Eyebrow tone="light">{washingtonHero.eyebrow}</Eyebrow>
            <h1 className="text-scrim mt-7 font-heading text-[48px] font-normal leading-[0.96] tracking-[-0.03em] text-background-50 md:text-[88px] lg:text-[108px]">
              Welcome to <em className="italic text-background-100">Washington</em>
            </h1>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-3">
              <CtaButton href={washingtonHero.primaryCta.href}>{washingtonHero.primaryCta.label}</CtaButton>
              <GhostButton href={washingtonHero.secondaryCta.href} tone="light">
                {washingtonHero.secondaryCta.label}
              </GhostButton>
            </div>
          </div>
          ...
          >
            ...
            <p className="font-heading text-[38px] leading-none text-background-50">Washington, D.C.</p>
            <p className="text-[13.5px] leading-relaxed text-background-200">
              The nation&rsquo;s capital pairs landmark architecture and world-class culture with deep, walkable
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="v2-rise grid w-full max-w-3xl grid-cols-2 gap-x-6 gap-y-7 sm:grid-cols-4" style={{ animationDelay: '340ms' }}>
            {washingtonHero.stats.map((stat) => (
