...
export default function AboutHero() {
  return (
    <section id="top" className="relative min-h-[92svh] w-full overflow-hidden bg-foreground-950">
      <img
        src={aboutHero.image}
        alt="The Washington DC metro skyline at dusk, the market BW Metro Properties serves"
        title="About Brandon Wilson — BW Metro Properties"
      ...
      <div className="relative mx-auto flex min-h-[92svh] max-w-[1500px] flex-col justify-between gap-12 px-5 pb-16 pt-36 md:px-10 md:pb-20 md:pt-44">
        <div className="v2-rise max-w-4xl">
          <Eyebrow tone="light">{aboutHero.eyebrow}</Eyebrow>
          <h1 className="text-scrim mt-7 font-heading text-[56px] font-normal leading-[0.96] tracking-[-0.03em] text-background-50 md:text-[104px] lg:text-[132px]">
            <em className="italic">{aboutHero.title}</em>
          </h1>
          ...
          >
            <CtaButton href="#contact">Work With Brandon</CtaButton>
            <GhostButton href="#meet" tone="light">
              Meet Brandon Wilson
            </GhostButton>
          </div>
        </div>
