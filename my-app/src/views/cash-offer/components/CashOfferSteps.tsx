...
import { cashOfferSteps } from '@/mocks/cashOfferData';

export default function CashOfferSteps() {
  return (
      ...
      <div className="mx-auto max-w-[1280px]">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-7 font-heading text-[32px] font-normal leading-[1.05] tracking-[-0.02em] text-foreground-950 md:text-[50px]">
            Three simple steps to your <em className="italic">offer</em>
          </h2>
          <p className="mt-6 text-[15px] leading-relaxed text-foreground-600 md:text-[16.5px]">
            No listings, no repairs, no uncertainty. Just a clear path from your address to a fair cash offer — and a
            closing date you choose.
          </p>
        </Reveal>

        <div className="mt-16 grid grid-cols-1 gap-5 md:grid-cols-3 md:gap-6">
          {cashOfferSteps.map((item, index) => (
