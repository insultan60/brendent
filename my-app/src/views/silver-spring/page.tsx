...
import SilverSpringHero from '@/views/silver-spring/components/SilverSpringHero';
...
import {
  ...
  schools,
  schoolsCopy,
} from '@/mocks/silverSpringData';

export default function SilverSpring() {
  useReveal();
  ...
  return (
    <div className="min-h-screen bg-background-100">
      ...
      <main>
        <SilverSpringHero />
        <AreaQuickNav areas={areaOptions} defaultLabel="Silver Spring" />
        <AreaListings
