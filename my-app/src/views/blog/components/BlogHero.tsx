...
import { blogHero } from '@/mocks/blogData';
...
export default function BlogHero() {
  return (
    <section id="top" className="relative min-h-[86svh] w-full overflow-hidden bg-foreground-950">
      ...
      <div className="relative mx-auto flex min-h-[86svh] max-w-[1500px] flex-col justify-between gap-12 px-5 pb-16 pt-36 md:px-10 md:pb-20 md:pt-44">
        <div className="v2-rise max-w-4xl">
          <Eyebrow tone="light">{blogHero.eyebrow}</Eyebrow>
          <h1 className="text-scrim mt-7 font-heading text-[56px] font-normal leading-[0.96] tracking-[-0.03em] text-background-50 md:text-[104px] lg:text-[132px]">
            <em className="italic">{blogHero.title}</em>
          </h1>
