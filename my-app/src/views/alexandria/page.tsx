...
import AlexandriaHero from '@/views/alexandria/components/AlexandriaHero';
...
export default function Alexandria() {
  ...
  return (
    <div className="min-h-screen bg-background-100">
      ...
      <main>
        <AlexandriaHero />
        <AreaQuickNav areas={areaOptions} defaultLabel="Alexandria" />
        <AreaListings
